  ...
  <div class="mt-16">
    ...
    <div class="flex flex-row justify-between p-4">
      <mcw-textfield
        ...
        label="Title"
        @input="(event: {target:{value:string}}) => newRecipe.title = event.target.value"
      />
    ...
    <div>
      <div>
        <div v-for="ingredient of newRecipe.ingredients" class="w-full">
          <div class="flex flex-row w-full justify-evenly gap-3 py-1">
            <mcw-textfield
            ...
            <mcw-textfield
              ...
              type="number"
            ></mcw-textfield>
            <mcw-select v-model="ingredient.unit" label="Unit of Amount">
              <mcw-list-item
                v-for="unit of amountUnitAsArray()"
                :key="unit"
                role="option"
              >{{ unit }}
              </mcw-list-item>
